...
import type { Announcement, Creator, Fancard, Service } from "@/types"

export const listCreators = (
    config: HttpClientConfig,
): Promise<Result<Creator[]>> =>
    request<Creator[]>("/v1/creators.txt", config)
...
export const getAnnouncements = (
    ...
    request<Announcement[]>(`/v1/${service}/user/${creatorId}/announcements`, config)
